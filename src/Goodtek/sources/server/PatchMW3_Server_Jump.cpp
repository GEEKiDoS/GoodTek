...
namespace Server
{
	...
	void PatchMW3_Jump()
	{
		HOOK_DETOUR(0x414120, hkJump_ApplySlowdown);
		HOOK_DETOUR(0x4141B0, hkJump_CalcHeightScale);
		HOOK_DETOUR(0x4142B0, hkJump_CalcHeightScale_Usercall);
		HOOK_DETOUR(0x413F40, hkJump_RegisterDvars);
	}
}